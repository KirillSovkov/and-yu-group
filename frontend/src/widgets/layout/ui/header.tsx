...
const feedbackItems: FeedbackItemsI[] = [
  { icon: <PhoneCall size={24} />, href: "tel:+79529346987" },
  {
    icon: <WhatsappLogo size={24} />,
    href: "https://api.whatsapp.com/send/?phone=79529346987&text&type=phone_number&app_absent=0",
  },
        ...
        <div className="items-center hidden gap-2 sm:flex">
          {feedbackItems.map((item, index) => (
            <Link key={index} href={item.href} target="_blank">
              <Button
                className="border-none text-foreground-700"
                isIconOnly
                variant="ghost"
                radius="sm"
                color="primary"
      ...
      <NavbarMenu className="items-end pb-20 mt-0">
        ...
        <div className="flex flex-col items-end gap-3 mt-auto">
          ...
          <div className="flex flex-col items-end mt-auto">
            <Link className="text-lg" href="mailto:hello@andyu.ru">
              hello@andyu.ru
            </Link>
            <Link className="text-lg" href="tel:89529346987">
              +7 (952) 934-69-87
            </Link>
          </div>
        </div>
